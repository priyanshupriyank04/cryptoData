...
# Progress checkpoint file - OKX SPECIFIC (separate from main checkpoint)
CHECKPOINT_FILE = os.path.join(PROJECT_ROOT, 'crypto_data', 'extraction_checkpoint_okx.json')
