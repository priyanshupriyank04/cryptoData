...
# Progress checkpoint file - HTX SPECIFIC (separate from main checkpoint)
CHECKPOINT_FILE = os.path.join(PROJECT_ROOT, 'crypto_data', 'extraction_checkpoint_htx.json')
