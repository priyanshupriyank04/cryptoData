...
CHECKPOINT_FILE = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'extraction_checkpoint_deribit.json')
...
def fetch_all_public_data(exchange, symbol, instrument_type, market_info, connection, table_name, 
    ...
    try:
        ...
        # Deribit has a maximum limit of 1000, use smaller batches for safety
        # Start with 1000, will reduce if we get INVALID_PARAM_VALUE errors
        optimized_limit = min(limit, 1000)  # Deribit max is typically 1000
